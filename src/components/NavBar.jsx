  ...
  const li = 
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <Link to="/" className="btn gap-0 btn-ghost text-xl lg:text-4xl font-extrabold bg-gradient-to-r from-yellow-400 to-pink-500 text-transparent bg-clip-text">
            CarrerCove
          </Link>
        </div>
                ...
                <div className="relative  group">
                  <div className="btn btn-ghost btn-circle avatar">
                    <div className="w-14 rounded-full">
                      <img
                        alt="Photo"
                        src={user.photo ? user.photo : "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg"}
                      />
                    </div>
                  </div>
