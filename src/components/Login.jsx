...
const provider = new GoogleAuthProvider();
	...
	<form onSubmit={handleSubmit} action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-md dark:text-gray-50 bg-primary font-bold bg-gradient-to-r from-yellow-400 to-pink-500">Sign in</button>
	</form>
